<?php require 'includes/header.php';
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        if (isset($_POST['reserve'])) {
            ...
            $reserve = mysqli_query($conn, "INSERT INTO `tbl_reservations` (`guest_name`, `guest_address`, `guest_contact`, `room_type`, `room_number`, `guest_arrival`,`end_reserve_date`, `number_of_nights`,`extra_bed`, `extra_person`, `extra_pillow`, `extra_blanket`, `extra_towel`,`trans_date`,`status`)
                VALUES ('$name','$address','$contact','$room_type','$room_number','$arr_date','$end_reserve_date', '$num_nights','$ex_bed','$ex_person','$ex_pillow','$ex_blanket','$ex_towel', NOW(), 'reserve')");

            if ($reserve) {
                ?>
                    <script type="text/javascript">
                        window.location = "manage_reservations.php?success"
                    </script>
                <?php
            }else{
                ?>
        ...
        <div class="content">
            ...
            <nav aria-label="breadcrumb" role="navigation">
              <ol class="breadcrumb" style="padding: 0; background: none; margin-top: -20px;">
                ...
                <li class="breadcrumb-item active float-right" aria-current="page"><i class="fa fa-file"></i> Reservation Form</li>
              </ol>
            </nav>
            <div class="card">
                 <div class="card-body">
            <div class="page-title text-center bg-teal-light" style="padding-top: 10px; padding-bottom: 1px;"><h2><i class="fa fa-hotel"></i> Reservation Form</h2></div>
            <hr>
