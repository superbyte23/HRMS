<?php require 'includes/header.php';
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        if (isset($_POST['reserve'])) {
            ...
            // insert query
            $reserve = mysqli_query($conn, "INSERT INTO `tbl_reservations` (`guest_name`, `guest_address`, `guest_contact`, `room_type`, `room_number`, `guest_arrival`,`end_reserve_date`, `number_of_nights`,`extra_bed`, `extra_person`, `extra_pillow`, `extra_blanket`, `extra_towel`,`status`)
                VALUES ('$name','$address','$contact','$room_type','$room_number','$arr_date','$end_reserve_date', '$num_nights','$ex_bed','$ex_person','$ex_pillow','$ex_blanket','$ex_towel', 'inactive')");

            if ($reserve) {
                ?>
                    <script type="text/javascript">
                        window.location = "records.php?success"
                    </script>
                <?php
            }else{
                ?>
        ...
        <!-- Breadcrumbs -->
            <nav aria-label="breadcrumb" role="navigation">
              <ol class="breadcrumb" style="padding: 0; background: none; margin-top: -20px;">
                ...
                <li class="breadcrumb-item active float-right" aria-current="page"><i class="fa fa-file"></i> Old Records Form</li>
              </ol>
            </nav>
            <div class="card">
                 <div class="card-body">
            <div class="page-title text-center bg-green-light" style="padding-top: 10px; padding-bottom: 1px;"><h2><i class="fa fa-hotel"></i> Insert Old Records Form</h2></div>
            <hr>
           <form id="needs-validation" novalidate method="POSt" action="#">
              <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    <div class="form-group" id="date_1">
                        ...
                        <div class="input-group date">
                            ...
                            <input class="form-control" type="text" name="arr_date" id="arr_date" value="" required>
                            <div class="invalid-feedback">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="time" class="form-control" id="check_in" placeholder="Check-In Time" name="check_in" required="">
                    <div class="invalid-feedback">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="time" class="form-control" id="check_out" placeholder="Check-Out Time" name="check_out" required="">
                    <div class="invalid-feedback">
                        Please provide a valid time.
                    </div>
                </div>
                <div class="col-md-6 mb-3">
                    <label for="num_nights"><i class="fa fa-lightbulb-o"></i> Number of Nights</label>
                     <input type="number" class="form-control" id="num_nights" placeholder="Number of Nights" name="num_nights" required>
                    <div class="invalid-feedback">
              ...
              <button class="btn btn-primary btn-block" name="reserve" type="submit" id="finish"><i class="fa fa-check"></i> Finish Booking</button>
            </form>
        </div>
    </div>
        </div>
